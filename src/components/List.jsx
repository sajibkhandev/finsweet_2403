...
const List = () => {
  return (
     ...
     <ul className='flex gap-x-[48px] text-base font-medium  font-pop cursor-pointer'>
        ...
        <li className='text-[#BBBBCB] duration-500 hover:text-white'>Pricing</li>
        <li className='text-[#BBBBCB] duration-500 hover:text-white'>FAQ</li>
        <li className='text-[#BBBBCB] duration-500 hover:text-white'>Blog</li>
     </ul>
